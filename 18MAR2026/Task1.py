...
web_site = driver.find_element(By.XPATH, '(//td[text()="jdoe@hotmail.com"]/following-sibling::td[2])[1]')
print('Web Site:', web_site.text)

del_link = driver.find_element(By.XPATH, '//table[@id="table1"]//td[text()="Bach"]/following-sibling::td/a[2]')
print('Delete Link:', del_link.text)

driver.find_element(By.XPATH, '//table[2]')
print('Second Table Found')

driver.find_element(By.XPATH, '//table[2]//td[text()="$100.00"]')
print('Cell containing $100.00 Found')

driver.find_element(By.XPATH, '//table[2]//td[text()="$100.00"]/parent::tr')
print('Its parent <tr> element Found')
